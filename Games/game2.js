...
// -----------
var angka = Math.floor(Math.random() * 20) + 1;
  console.log(angka);
...
function a(id) {
  ...
  if (random == id) {
    ...
    console.log()
    if(id < random){
      document.getElementById('text6').innerHTML = 'Tebakan Salah, Semangat'
    } else if(id > random){
      document.getElementById('text6').innerHTML = 'Tebakan Salah, Ayo lagii'
    }
